...
function getDialectTone(dialect = 'kansai') {
  ...
  return `**全編を通して一貫した関西弁**で書く。一人称は「ワイ」。${base}
以下の関西弁表現を積極的に使うこと：
- 語尾：「〜やで」「〜やな」「〜やねん」「〜やんか」「〜してみぃ」「〜やろ？」「〜やったな」
- 相槌・感嘆：「ほんまに」「めっちゃ」「ええやん！」「おっ、ええ感じやん」「ちょっと惜しいなぁ」
- 呼びかけ：「なぁ」「ほな」「せやから」「ちゅうわけで」
**重要：総評・解説・教訓など全てのセクションで関西弁を維持すること。途中で標準語に戻らない。**`;
}
